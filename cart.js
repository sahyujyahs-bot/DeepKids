...
(function () {
  ...
  var CSS = [
    ...
    '#dkc-wish-btn svg{stroke:#ff7597}',
    '.dkc-badge{position:absolute;top:2px;right:0;min-width:18px;height:18px;padding:0 5px;',
      'border-radius:999px;background:#c6f24e;color:#0a0618;font-family:"Norwester",sans-serif;',
    ...
    '#dkc-wish-btn .dkc-badge{background:#ff7597;color:#fff}',
    ...
    '.dkc-total b{font-size:20px;color:#c6f24e;font-weight:normal}',
    '.dkc-go{display:block;width:100%;text-align:center;cursor:pointer;border:0;',
      ...
      'color:#0a0618;background:#c6f24e;border-radius:999px;padding:11px;transition:filter .2s ease}',
    ...
    '.dkc-add{flex-shrink:0;cursor:pointer;border:0;border-radius:999px;padding:6px 13px;',
      ...
      'color:#0a0618;background:#c6f24e;transition:filter .2s ease}',
